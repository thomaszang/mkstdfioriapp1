		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori App",
									"targetURL": "#mkstdfioriapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mkstdfioriapp1-display": {
								"semanticObject": "mkstdfioriapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mkstdfioriapp1",
									"url": sap.ui.require.toUrl("mkstdfioriapp1")
								}
							}
						}
					}
